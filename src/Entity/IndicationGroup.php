...
use App\Repository\IndicationGroupRepository;
...
class IndicationGroup
{
    ...
    #[ORM\OneToMany(mappedBy: 'indicationGroup', targetEntity: MedicalProduct::class)]
    ...
    public function addMedicalProduct(MedicalProduct $medicalProduct): self
    {
        if (!$this->medicalProducts->contains($medicalProduct)) {
            ...
            $medicalProduct->setIndicationGroup($this);
        }
    ...
    public function removeMedicalProduct(MedicalProduct $medicalProduct): self
    {
        if ($this->medicalProducts->removeElement($medicalProduct)) {
            ...
            if ($medicalProduct->getIndicationGroup() === $this) {
                $medicalProduct->setIndicationGroup(null);
            }
        }
