...
use App\Repository\WrappingRepository;
use Doctrine\Common\Collections\ArrayCollection;
use Doctrine\Common\Collections\Collection;
use Doctrine\ORM\Mapping as ORM;

#[ORM\Entity(repositoryClass: WrappingRepository::class)]
class Wrapping
{
    #[ORM\Id]
    #[ORM\Column]
    ...
    #[ORM\OneToMany(mappedBy: 'wrapping', targetEntity: MedicalProduct::class)]
    ...
    public function addMedicalProduct(MedicalProduct $medicalProduct): self
    {
        if (!$this->medicalProducts->contains($medicalProduct)) {
            ...
            $medicalProduct->setWrapping($this);
        }
    ...
    public function removeMedicalProduct(MedicalProduct $medicalProduct): self
    {
        if ($this->medicalProducts->removeElement($medicalProduct)) {
            ...
            if ($medicalProduct->getWrapping() === $this) {
                $medicalProduct->setWrapping(null);
            }
        }
