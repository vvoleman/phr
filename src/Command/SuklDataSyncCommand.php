...
use App\Service\SUKL\CsvSyncer;
use App\Service\SUKL\LoadZipFile;
...
class SuklDataSyncCommand extends Command
{
	...
	public function __construct(private readonly LoadZipFile $zipFile, private readonly CsvSyncer $csvSyncer) { parent::__construct(); }
