 ...
 */
final class Version20221215210210 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE medical_product (id VARCHAR(255) NOT NULL, form_id VARCHAR(255) DEFAULT NULL, administration_method_id VARCHAR(255) DEFAULT NULL, wrapping_id VARCHAR(255) DEFAULT NULL, country_holder_id VARCHAR(255) DEFAULT NULL, registration_status_id VARCHAR(255) DEFAULT NULL, indication_group_id VARCHAR(255) DEFAULT NULL, dispensing_id VARCHAR(255) DEFAULT NULL, addiction_id VARCHAR(255) DEFAULT NULL, doping_id VARCHAR(255) DEFAULT NULL, document_id VARCHAR(255) NOT NULL, sukl_code VARCHAR(255) NOT NULL, name VARCHAR(255) NOT NULL, strength VARCHAR(255) NOT NULL, packaging VARCHAR(255) NOT NULL, addition VARCHAR(255) NOT NULL, registration_holder VARCHAR(255) NOT NULL, recently_delivered TINYINT(1) NOT NULL, expiration_hours INT DEFAULT NULL, INDEX IDX_9548E4635FF69B7D (form_id), INDEX IDX_9548E46315BADB29 (administration_method_id), INDEX IDX_9548E463730A3343 (wrapping_id), INDEX IDX_9548E4636B0D67B0 (country_holder_id), INDEX IDX_9548E46388ABFED8 (registration_status_id), INDEX IDX_9548E463C24E3835 (indication_group_id), INDEX IDX_9548E463DD51E94B (dispensing_id), INDEX IDX_9548E46330C0E13B (addiction_id), INDEX IDX_9548E463342DE21C (doping_id), UNIQUE INDEX UNIQ_9548E463C33F7837 (document_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
